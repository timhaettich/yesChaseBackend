...
app.use('/cards', auth(null), cardsRouter);
app.use('/team', auth(null), teamRouter);
app.use('/transport', auth(null), transportRouter);
app.use('/gps', auth(null), gpsRouter);
app.use('/admin', auth(1), adminRouter);
automaticSwap()
